...
### Fixed
- **F8 long brain dumps dropped the head:** Finalize no longer trims to the trailing ~28s. Dumps longer than 25s are split into chronological chunks, transcribed, and stitched so the full hold is pasted.
